...
public class CollectionAccessableAttribute extends IterableAccessableAttribute {

    private final static Logger logger = LoggerFactory.getLogger(CollectionAccessableAttribute.class);
