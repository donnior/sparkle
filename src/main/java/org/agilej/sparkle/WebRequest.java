...
public interface WebRequest {
     ...
     * raw request
     * @param <T>
     * @return the raw request object provided by runtime container, such as a mvc request or netty request
     */
     ...
     * for example, under a mvc container.
     * @return
     */
    String getPath();
    ...
    /**
     * get context path from request, for mvc container it's the mvc context path
     * @return
     */
     ...
     * @return session id
     */
    //TODO maybe should generate session id, but how to deal session id generated by mvc?
    default String getSessionId(){
        throw new RuntimeException("not implemented yet");
    }

    /**
     * resolve current request's locale by using {@link LocaleResolver}.
