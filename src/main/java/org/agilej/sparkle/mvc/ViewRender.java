 ...
 *  
 *  Because Sparkle is designed to be running under several environments such as netty server or mvc container,
 *  these feature comes with the vender-provided view render, for example under mvc container you can use the
