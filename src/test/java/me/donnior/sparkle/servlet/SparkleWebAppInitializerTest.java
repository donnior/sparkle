...
public class SparkleWebAppInitializerTest {
    ...
    public void testFail() throws ServletException{
        SparkleWebAppInitializer initializer = new SparkleWebAppInitializer();
        initializer.onStartup(null, new FailedServletContextAdapter());
    }

}

class SucceedServletContextAdapter implements ServletContext {
    ...
    public javax.servlet.ServletRegistration.Dynamic addServlet(String arg0,
            Servlet arg1) {
        return new javax.servlet.ServletRegistration.Dynamic() {
...
class FailedServletContextAdapter implements ServletContext {
